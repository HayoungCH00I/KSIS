                    ...
                    <div className="px-4 pb-5 pt-1 border-t border-slate-100/80 bg-slate-50/50 space-y-4 animate-in fade-in duration-200">
                      ...
                      <div>
                        <div className="flex items-center gap-1.5 text-xs font-black text-slate-800">
                          ...
                          <span>참석 확정 시니어 ({ev.rsvps.length}명)</span>
                        </div>
                        {ev.rsvps.length === 0 ? (
                ...
                return (
                  ...
                  >
                    <div className="flex justify-between items-center w-full">
                      ...
                      {dayEvents.length > 0 && (
                        <span className="w-1.5 h-1.5 rounded-full bg-blue-900 inline-block animate-bounce shrink-0" />
                      )}
                    </div>
                    ...
                    <div className="w-full">
                      {dayEvents.slice(0, 1).map((ev) => (
                        <div
                          key={ev.id}
                          className="text-[7px] font-bold text-center leading-3 py-0.5 rounded-sm bg-[#0d34a6] text-white overflow-hidden text-ellipsis whitespace-nowrap"
                        >
                          행사
                        </div>
                      ))}
              ...
              <div className="mt-4 pt-4 border-t border-slate-100 space-y-4 text-left animate-in fade-in duration-200">
                ...
                <div>
                  <div className="flex items-center gap-1.5 text-xs font-black text-slate-800 mb-1.5">
                    <Users size={12} className="text-[#0d34a6]" />
                    <span>참석 확정 시니어 ({selectedEvent.rsvps.length}명)</span>
                  </div>
                  {selectedEvent.rsvps.length === 0 ? (
